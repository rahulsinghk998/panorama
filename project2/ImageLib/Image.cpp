...
uchar CImageOf<uchar>::MinVal(void)     { return 0; }
uchar CImageOf<uchar>::MaxVal(void)     { return 255; }
int   CImageOf<int  >::MinVal(void)     { return -1 ^ (1 << 31); }
int   CImageOf<int  >::MaxVal(void)     { return  0 ^ (1 << 31); }
float CImageOf<float>::MinVal(void)     { return -FLT_MAX; }
float CImageOf<float>::MaxVal(void)     { return FLT_MAX; }
